...
#segments = audioSegmentation.speaker_diarization(r'C:\Users\almakarenkov\PycharmProjects\transcript\Case study clinical example CBT： First session with a client with symptoms of depression (CBT model) [7LD8iC4NqXM].wav', n_speakers=2)
